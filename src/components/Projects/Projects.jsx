...
function Projects() {
  ...
  setInterval(document.querySelector('.slideshow-holder').offsetWidth - slideShowLength);
      ...
      <div class="container-mid text-med text-[24px] pt-5 md:text-[24px] lg:text-[38px] xl:text-[38px] 2xl:text-[42px]">
        ...
        <div class="project-container ">
          <div id="project-gallery" class="relative square">
            <div
              class="flex items-center absolute top-40 -left-[3%] z-10"
              id="project-left"
              onClick={handleClick}
            >
              {"<"}
            ...
            <div
              class="flex items-center absolute top-40 -right-[3%] z-10"
              id="project-right"
              onClick={handleClick}
            >
              {">"}{" "}
